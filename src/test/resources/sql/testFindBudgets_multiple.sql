...
insert into budget(id, name, current_amount, limit_amount, period, wallet_id) values(2, 'Budget 2', 500, 1000, 'MONTHLY', 1);

insert into budget_category(budget_id, category_id) values(1, 2);
insert into budget_category(budget_id, category_id) values(1, 3);

insert into budget_category(budget_id, category_id) values(2, 2);
insert into budget_category(budget_id, category_id) values(2, 5);